...
namespace KetQuaSoBong.Views.TabViews.GroupTabViews
{
    ...
    public partial class FootballChatView : ContentView
    {
        ...
        {
            InitializeComponent();
            BindingContext = new FootballChatViewVM(this);
        }
    }

    internal class FootballChatViewVM : BindableBase 
    {
        ...
        public FootballChatViewVM(ContentView contentView)
        {
            ...
            SendCommand = new Command(async () =>
            {
                if (ContentChat != "")
                {
                    ...
                    string name = user[0];
                    string url = "https://api.tructiepketqua.net/api/Chats/BongDa/"+ userName + "/" + name + "?message=" + ContentChat;
